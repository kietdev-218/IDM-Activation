...
:MainMenu
cls
title  IDM Auto Activate by KietDev
mode 65, 25
...
call :_color2 %_White% "                      " %_Green% " IDM Auto Activation "
echo:                    _________________________
call :_color2 %_White% "                          " %_Yellow% " by KietDev "
call :_color2 %_White% "                          " %_Blue% "   v2.0.0 "
echo:
echo:       ___________________________________________________
echo:                                                          
echo:          [1] Activate IDM                                
echo:          [2] Reset Trial 30 Days    
echo:          [3] Homepage                                    
echo:          [4] Exit                                        
echo:
echo:       ___________________________________________________
...
:: Calculate the number of progress characters
set /a "progressChars=percentage * totalSteps / 100"

:: Display the progress bar
set "progress="
for /l %%i in (1,1,%progressChars%) do (
    set "progress=!progress!▌"
)
<nul set /p "=Progress: [!progress!!progress:▌ = !] !percentage!%%^r"
ping -n 1 localhost >nul
::========================================================================================================================================

:_reset
cls
title  IDM Auto Activate by KietDev - Reset Trial 30 Days
mode 93, 32
...
call :_color %Green% "Trial is successfully reset in the registry."
) else (
...
:_activate
cls
title  IDM Auto Activate by KietDev - Activate IDM
mode 93, 32
...
:homepage
cls
title  IDM Auto Activate by KietDev - Homepage
mode 93, 32

cls
echo:
echo:
echo Going to the homepage...

echo:
echo:
timeout /t 3

start https://www.kietdev.xyz/
goto MainMenu
...
If not defined name set name=KietDev
...
set "reg=HKCU\SOFTWARE\DownloadManager /v Email /t REG_SZ /d "idm@kietdev.xyz"" & call :_rcont
